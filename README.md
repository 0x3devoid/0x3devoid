...
# Hi there, I'm Owoyemi Idris Olamilekan 👋
...
- 🔭 I'm currently working on **edQorta**
...
![Ether.js](https://img.shields.io/badge/ether.js-F16822?style=for-the-badge&logo=web3.js&logoColor=white)
...
![Firebase](https://img.shields.io/badge/redis-%23DD0031.svg?style=for-the-badge&logo=redis&logoColor=white)
...
Discover Your Dream Home here. The foundational trust layer for African real estate.

**Technologies:** `Nextjs` `Typescript` `Tailwindcss` `Node.js` `MongoDb`

**My Role:** Lead Developer | Frontend Implementation

🔗 **[Live Demo](https://edqorta.com/)** | 📄 **[Documentation](https://edqorta.com/)**

---

### 🔗 Lollipoo Dex

> **A native dex built on EVM**

Lollipoo is a multichain Decentralized exchange. This is not just an Exchange, it comes with extra facinating features to make trading simple and easier.

**Technologies:** `TypeScript` `Next.js` `TailwindCss` `Etherjs` `Web3modal` `Solidity`

**My Role:** Blockchain Developer | Architecture Design | Contract Design & Implementation

🔗 **[Live Demo](https://lollipoo.vercel.app/)**

---

### 🔗 Pumpevm

> **A multichain launchpad fully compatible with all EVM networks.**

Real degens, real hype, real pumps.Tokens are for the crowd — you decide who’s mooning next!

**Technologies:** `TypeScript` `Next.js` `TailwindCss` `Etherjs` `Web3modal` `Solidity` `Mongodb` `Express.js` `Nodejs`
...
> **A bridge between crypto trading and stock market**

CompanyFi is an on-chain economic arena where users can instantly incorporate comapanies, issue share, and engage in perpetual game of corporate warfare.

**Technologies:** `TypeScript` `Next.js` `TailwindCss` `Etherjs` `Web3modal` `Solidity` `Mongodb` `Express.js` `Nodejs`

**My Role:** Fullstack Developer | Infrastructure Setup | Smart Contract Development

🔗 **[Live Demo](https://companyfi-dapp.vercel.app/)**

---

## 🎯 Current Focus

I'm currently working on **edQorta**, a real estate solution. The foundational trust layer for African real estate.

**Tech Stack:** `Nextjs` `Typescript` `Tailwindcss` `Node.js` `MongoDb`
